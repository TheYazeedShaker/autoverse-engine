...
| --- | -------------------------- | ----------------------------------------------------------- | ------------- | ------------- | ------------------------------------------------------------------------------------ |
| 0a  | BLOCK-FIX-7                | PROGRESS.md: BLOCK finding #7                               | —             | queued        | First unattended-loop task                                                           |
| 0b  | BLOCK-FIX-8                | PROGRESS.md: BLOCK finding #8                               | —             | queued        |                                                                                      |
...
| 3   | AUTONOMOUS-LOOP-P2         | specs/SPEC-autonomous-loop.md (Part 2)                      | #1 phase gate | in-progress   | Runner, tiered auto-merge,digest,Interactive sessions only — not for unattended runs |
